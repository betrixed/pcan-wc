...
use Plates\Template\Data;
use Plates\Template\Directory;
use Plates\Template\FileExtension;
use Plates\Template\Folders;
use Plates\Template\Func;
use Plates\Template\Functions;
use Plates\Template\Name;
use Plates\Template\Template;

/**
 * Template API and environment settings storage.
 * Taken from verison 3.3 of League/Plates
 */
class Engine
{
    /**
