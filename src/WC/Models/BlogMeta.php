...
class BlogMeta extends \Phiz\Mvc\Model
{
    ...
    public function initialize()
    {
        ...
        $this->belongsTo('meta_id', 'WC\Models\Meta', 'id', ['alias' => 'Meta']);
    }
     ...
     * @return BlogMeta[]|BlogMeta|\Phiz\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return BlogMeta|\Phiz\Mvc\Model\ResultInterface
     */
