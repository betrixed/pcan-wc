...
class BlogCategory extends \Phiz\Mvc\Model
{
    ...
    public function initialize()
    {
        ...
        $this->hasMany('id', 'WC\Models\BlogToCategory', 'category_id', ['alias' => 'BlogToCategory']);
    }
     ...
     * @return BlogCategory[]|BlogCategory|\Phiz\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return BlogCategory|\Phiz\Mvc\Model\ResultInterface
     */
