...
class Blog extends \Phiz\Mvc\Model
{
    ...
    public function initialize()
    {
        ...
        $this->setSource("blog");
        $this->hasMany('id', 'WC\Models\BlogComment', 'blog_id', ['alias' => 'BlogComment']);
        $this->hasMany('id', 'WC\Models\BlogMeta', 'blog_id', ['alias' => 'BlogMeta']);
        $this->hasMany('id', 'WC\Models\BlogRelated', 'blog_related_id', ['alias' => 'BlogRelated']);
        $this->hasMany('id', 'WC\Models\BlogRevision', 'blog_id', ['alias' => 'BlogRevision']);
        $this->hasMany('id', 'WC\Models\BlogTag', 'blog_id', ['alias' => 'BlogTag']);
        $this->hasMany('id', 'WC\Models\BlogToCategory', 'blog_id', ['alias' => 'BlogToCategory']);
        $this->hasMany('id', 'WC\Models\Event', 'blogid', ['alias' => 'Event']);
        $this->hasMany('id', 'WC\Models\FileUpload', 'blog_id', ['alias' => 'FileUpload']);
        $this->belongsTo('style', 'WC\Models\BlogStyle', 'style_class', ['alias' => 'BlogStyle']);
    }
     ...
     * @return Blog[]|Blog|\Phiz\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return Blog|\Phiz\Mvc\Model\ResultInterface
     */
