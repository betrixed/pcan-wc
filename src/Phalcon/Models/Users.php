...
class Users extends \Phalcon\Mvc\Model
{
    ...
    public function initialize()
    {
        ...
        $this->hasMany('id', 'App\Models\EmailConfirmations', 'usersId', ['alias' => 'EmailConfirmations']);
        $this->hasMany('id', 'App\Models\PasswordChanges', 'usersId', ['alias' => 'PasswordChanges']);
        $this->hasMany('id', 'App\Models\RememberTokens', 'usersId', ['alias' => 'RememberTokens']);
        $this->hasMany('id', 'App\Models\SuccessLogins', 'usersId', ['alias' => 'SuccessLogins']);
        $this->hasMany('id', 'App\Models\UserAuth', 'userId', ['alias' => 'UserAuth']);
        $this->hasMany('id', 'App\Models\UserEvent', 'user_id', ['alias' => 'UserEvent']);
    }
